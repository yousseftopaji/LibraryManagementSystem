...
class BookServiceImplTest {
    ...
    @Test
    @DisplayName("Should handle null response from gRPC service")
    void testGetAllBooks_NullResponse() {
        // Arrange
        when(bookGrpcService.getAllBooks()).thenReturn(null);
    ...
    @Test
    @DisplayName("Should throw exception when gRPC returns null")
    void testGetBookByIsbn_NullResponse() {
        // Arrange
        String isbn = "978-0-123456-47-2";
        when(bookGrpcService.getBooksByIsbn(isbn)).thenReturn(null);
