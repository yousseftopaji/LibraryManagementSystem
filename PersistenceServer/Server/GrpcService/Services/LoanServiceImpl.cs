    ...
    : LoanService.LoanServiceBase
{
    ...
    public override async Task<GetLoansByISBNResponse> GetLoansByISBN(GetLoansByISBNRequest request,
    ...
    public override async Task<GetActiveLoansByUsernameResponse> GetActiveLoansByUsername(
        GetActiveLoansByUsernameRequest request, ServerCallContext context)
    {
